...
<div class="<?=$this->params['controller']?> <?=$html->action?>">
    <?php echo $form->create('Checkup', array('action' => 'report_checktypes'));?>
	<fieldset>
 		<legend>REKAPITULASI PEMERIKSAAN KESEHATAN</legend>
        <table class="input">
            <tr id="afterThis">
...
<?php else: ?>
<h1>REKAPITULASI PEMERIKSAAN KESEHATAN <br />Per <?php echo $month . ' ' . $year;?></h1>
<br />
<center>
<table>
    <thead>
